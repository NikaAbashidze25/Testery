...
import { Send, Image as ImageIcon, Smile, Reply, MoreHorizontal, X, Edit, Trash2, Pin, Info, Search, Paperclip, Phone, Video, Menu } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full">
        {!activeChat ? (
          <div className="flex flex-col h-full items-center justify-center text-center bg-muted/50 p-8">
             <Button onClick={() => setLeftPanelOpen(true)} className="md:hidden absolute top-4 left-4" variant="ghost" size="icon">
                <Menu />
            </Button>
          ...
          <div className="flex flex-col h-full flex-1">
            ...
            <header className="flex items-center gap-3 border-b p-3 h-16 flex-shrink-0">
               <Button onClick={() => setLeftPanelOpen(true)} className="md:hidden" variant="ghost" size="icon">
                  <Menu />
              </Button>
              <Avatar>
      ...
      {/* Right Panel */}
       {activeChat && (
        <div className={cn(
          "fixed md:relative z-10 md:z-auto h-full w-full lg:w-1/4 lg:flex flex-col flex-shrink-0 transition-transform duration-300 ease-in-out",
